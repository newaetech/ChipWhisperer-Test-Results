...
.. parsed-literal::
    ...
    /tmp/ipykernel\_1739/3539254002.py:142: TqdmDeprecationWarning: Please use \`tqdm.notebook.trange\` instead of \`tqdm.tnrange\`
      for i in tnrange(N, desc='Capturing traces'):
...
.. image:: img/CWNANO-CWNANO-SOLN_Lab3_1-LargeHammingWeightSwings_14_0.png
