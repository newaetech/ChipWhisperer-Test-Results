...
.. parsed-literal::
    ...
    arm-none-eabi-gcc -mcpu=cortex-m4 -I. -mthumb -mfloat-abi=soft -fmessage-length=0 -ffunction-sections -gdwarf-2 -DSS\_VER=SS\_VER\_2\_1 -DSTM32F303xC -DSTM32F3 -DSTM32 -DDEBUG -DHAL\_TYPE=HAL\_stm32f3 -DPLATFORM=CWLITEARM -DF\_CPU=7372800UL -DSS\_VER\_2\_0=2 -DSS\_VER\_2\_1=3 -DSS\_VER\_1\_1=1 -DSS\_VER\_1\_0=0 -Os -funsigned-char -funsigned-bitfields -fshort-enums -Wall -Wstrict-prototypes -Wa,-adhlns=objdir-CWLITEARM/basic-passwdcheck.o -I.././simpleserial/ -I.././hal -I.././hal/stm32f3 -I.././hal/stm32f3/CMSIS -I.././hal/stm32f3/CMSIS/core -I.././hal/stm32f3/CMSIS/device -I.././hal/stm32f4/Legacy -I.././crypto/ -std=gnu99  -MMD -MP -MF .dep/basic-passwdcheck-CWLITEARM.elf.d objdir-CWLITEARM/basic-passwdcheck.o objdir-CWLITEARM/simpleserial.o objdir-CWLITEARM/stm32f3\_hal.o objdir-CWLITEARM/stm32f3\_hal\_lowlevel.o objdir-CWLITEARM/stm32f3\_sysmem.o objdir-CWLITEARM/stm32f3\_startup.o --output basic-passwdcheck-CWLITEARM.elf --specs=nano.specs --specs=nosys.specs -T .././hal/stm32f3/LinkerScript.ld -Wl,--gc-sections -lm -Wl,-Map=basic-passwdcheck-CWLITEARM.map,--cref   -lm  
    .
    ...
    Size after:
       ...
       4968	      8	   1176	   6152	   1808	basic-passwdcheck-CWLITEARM.elf
    +--------------------------------------------------------
    ...
    Attempting to program 4975 bytes at 0x8000000
    STM32F Programming flash...
    STM32F Reading flash...
    Verified flash OK, 4975 bytes
...
.. parsed-literal::
    ...
    [ 0.0546875  -0.09863281 -0.07519531 ... -0.01660156  0.04101562
      0.05371094]
...
.. parsed-literal::
    ...
    o diff = 8.5869140625
    p diff = 8.84765625
    q diff = 10.1513671875
    r diff = 9.0751953125
    s diff = 5.3173828125
    t diff = 10.9208984375
    u diff = 6.2998046875
    v diff = 11.0712890625
    w diff = 9.8095703125
    x diff = 259.552734375
    y diff = 8.3359375
    z diff = 7.212890625
    0 diff = 9.1064453125
    1 diff = 5.40234375
    2 diff = 10.02734375
    3 diff = 10.9228515625
    4 diff = 6.8388671875
    5 diff = 9.404296875
    6 diff = 11.16015625
    7 diff = 9.271484375
