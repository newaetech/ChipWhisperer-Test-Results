...
.. parsed-literal::
    ...
    /tmp/ipykernel\_1733/3751292750.py:142: TqdmDeprecationWarning: Please use \`tqdm.notebook.trange\` instead of \`tqdm.tnrange\`
      for i in tnrange(N, desc='Capturing traces'):
...
.. image:: img/OPENADC-CWLITEXMEGA-SOLN_Lab3_1-LargeHammingWeightSwings_14_0.png
