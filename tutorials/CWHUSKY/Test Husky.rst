...
.. parsed-literal::
    ...
    platform linux -- Python 3.10.2, pytest-8.3.3, pluggy-1.5.0 -- /home/testserveradmin/.pyenv/versions/cwtests/bin/python
    ...
    ../../tests/test\_husky.py::test\_target\_internal\_ramp[900000-0-internal-10000000.0-True-1-8-True-65536-65536-True-1-0-midstream] [31mFAILED[0m
    ../../tests/test\_husky.py::test\_target\_internal\_ramp[900000-0-internal-8000000.0-True-1-8-True-65536-65536-True-1-0-slowstream] [31mFAILED[0m
    ../../tests/test\_husky.py::test\_target\_internal\_ramp[900000-0-internal-5000000.0-True-1-12-True-65536-65536-True-1-0-slowerstream12] [31mFAILED[0m
    ../../tests/test\_husky.py::test\_target\_internal\_ramp[900000-0-internal-5000000.0-True-1-8-True-65536-65536-True-1-0-slowerstream] [31mFAILED[0m
    ...
    ../../tests/test\_husky.py::test\_target\_internal\_ramp[200-0-internal-20000000.0-True-1-8-False-65536-65536-True-1-0-quick] [31mFAILED[0m
    ../../tests/test\_husky.py::test\_target\_internal\_ramp[max-0-internal-15000000.0-True-1-12-False-65536-65536-True-1-0-maxsamples12] [31mFAILED[0m
    ../../tests/test\_husky.py::test\_target\_internal\_ramp[400000-0-internal-20000000.0-True-1-8-True-65536-65536-True-1-0-quickstream8] [31mFAILED[0m
    ...
    [1m[31m../../tests/test\_husky.py[0m:635: in test\_internal\_ramp
        [0merrors, first\_error = check\_ramp(raw, testmode, bits, samples, segment\_cycles)[90m[39;49;00m
    [1m[31m../../tests/test\_husky.py[0m:225: in check\_ramp
        [0mcurrent\_count = (current\_count + segment\_cycles - samples) % MOD[90m[39;49;00m
    [1m[31mE   OverflowError: Python integer 131124 out of bounds for uint16[0m
    ...
    [1m[31m../../tests/test\_husky.py[0m:635: in test\_internal\_ramp
        [0merrors, first\_error = check\_ramp(raw, testmode, bits, samples, segment\_cycles)[90m[39;49;00m
    [1m[31m../../tests/test\_husky.py[0m:188: in check\_ramp
        [0mcurrent\_count = (current\_count + (segment\_cycles - samples)//[94m4[39;49;00m) % MOD[90m[39;49;00m
    [1m[31mE   OverflowError: Python integer -32781 out of bounds for uint16[0m
    ...
    [1m[31m../../tests/test\_husky.py[0m:834: in test\_glitch\_width
        [0m[94massert[39;49;00m (ratio > offset\_percent - margin) [95mand[39;49;00m (ratio < offset\_percent + margin), [33m"[39;49;00m[33mRatio out of bounds ([39;49;00m[33m%f[39;49;00m[33m)[39;49;00m[33m"[39;49;00m % ratio[90m[39;49;00m
    [1m[31mE   AssertionError: Ratio out of bounds (0.705078)[0m
    [1m[31mE   assert (0.705078125 > (0.7619047619047619 - 0.05))[0m
    [31m[1m\_ test\_target\_internal\_ramp[900000-0-internal-10000000.0-True-1-8-True-65536-65536-True-1-0-midstream] \_[0m
    [1m[31m../../tests/test\_husky.py[0m:1115: in test\_target\_internal\_ramp
        [0merrors, first\_error = check\_ramp(raw, testmode, bits, samples, segment\_cycles)[90m[39;49;00m
    [1m[31m../../tests/test\_husky.py[0m:216: in check\_ramp
        [0m[94mif[39;49;00m byte != (current\_count+[94m1[39;49;00m)%MOD:[90m[39;49;00m
    [1m[31mE   OverflowError: Python integer 256 out of bounds for uint8[0m
    [31m[1m\_ test\_target\_internal\_ramp[900000-0-internal-8000000.0-True-1-8-True-65536-65536-True-1-0-slowstream] \_[0m
    [1m[31m../../tests/test\_husky.py[0m:1115: in test\_target\_internal\_ramp
        [0merrors, first\_error = check\_ramp(raw, testmode, bits, samples, segment\_cycles)[90m[39;49;00m
    [1m[31m../../tests/test\_husky.py[0m:216: in check\_ramp
        [0m[94mif[39;49;00m byte != (current\_count+[94m1[39;49;00m)%MOD:[90m[39;49;00m
    [1m[31mE   OverflowError: Python integer 256 out of bounds for uint8[0m
    [31m[1m\_ test\_target\_internal\_ramp[900000-0-internal-5000000.0-True-1-12-True-65536-65536-True-1-0-slowerstream12] \_[0m
    [1m[31m../../tests/test\_husky.py[0m:1115: in test\_target\_internal\_ramp
        [0merrors, first\_error = check\_ramp(raw, testmode, bits, samples, segment\_cycles)[90m[39;49;00m
    [1m[31m../../tests/test\_husky.py[0m:225: in check\_ramp
        [0mcurrent\_count = (current\_count + segment\_cycles - samples) % MOD[90m[39;49;00m
    [1m[31mE   OverflowError: Python integer 900000 out of bounds for uint16[0m
    [31m[1m\_ test\_target\_internal\_ramp[900000-0-internal-5000000.0-True-1-8-True-65536-65536-True-1-0-slowerstream] \_[0m
    [1m[31m../../tests/test\_husky.py[0m:1115: in test\_target\_internal\_ramp
        [0merrors, first\_error = check\_ramp(raw, testmode, bits, samples, segment\_cycles)[90m[39;49;00m
    [1m[31m../../tests/test\_husky.py[0m:216: in check\_ramp
        [0m[94mif[39;49;00m byte != (current\_count+[94m1[39;49;00m)%MOD:[90m[39;49;00m
    [1m[31mE   OverflowError: Python integer 256 out of bounds for uint8[0m
    [31m[1m\_ test\_target\_internal\_ramp[200-0-internal-20000000.0-True-1-8-False-65536-65536-True-1-0-quick] \_[0m
    [1m[31m../../tests/test\_husky.py[0m:1115: in test\_target\_internal\_ramp
        [0merrors, first\_error = check\_ramp(raw, testmode, bits, samples, segment\_cycles)[90m[39;49;00m
    [1m[31m../../tests/test\_husky.py[0m:216: in check\_ramp
        [0m[94mif[39;49;00m byte != (current\_count+[94m1[39;49;00m)%MOD:[90m[39;49;00m
    [1m[31mE   OverflowError: Python integer 256 out of bounds for uint8[0m
    [31m[1m\_ test\_target\_internal\_ramp[max-0-internal-15000000.0-True-1-12-False-65536-65536-True-1-0-maxsamples12] \_[0m
    [1m[31m../../tests/test\_husky.py[0m:1115: in test\_target\_internal\_ramp
        [0merrors, first\_error = check\_ramp(raw, testmode, bits, samples, segment\_cycles)[90m[39;49;00m
    [1m[31m../../tests/test\_husky.py[0m:225: in check\_ramp
        [0mcurrent\_count = (current\_count + segment\_cycles - samples) % MOD[90m[39;49;00m
    [1m[31mE   OverflowError: Python integer 131124 out of bounds for uint16[0m
    [31m[1m\_ test\_target\_internal\_ramp[400000-0-internal-20000000.0-True-1-8-True-65536-65536-True-1-0-quickstream8] \_[0m
    [1m[31m../../tests/test\_husky.py[0m:1115: in test\_target\_internal\_ramp
        [0merrors, first\_error = check\_ramp(raw, testmode, bits, samples, segment\_cycles)[90m[39;49;00m
    [1m[31m../../tests/test\_husky.py[0m:216: in check\_ramp
        [0m[94mif[39;49;00m byte != (current\_count+[94m1[39;49;00m)%MOD:[90m[39;49;00m
    ...
    test\_husky.py::test\_internal\_ramp[max-0-internal-20000000.0-True-1-12-False-1-0-1-maxsamples12]
    test\_husky.py::test\_internal\_ramp[max-0-internal-max-True-1-12-False-1-0-10-fastest]
    test\_husky.py::test\_internal\_ramp[max-0-internal-over2-True-1-12-False-1-0-1-overclocked]
    test\_husky.py::test\_internal\_ramp[max-0-internal-50000000.0-True-4-12-False-1-0-1-4xfast]
    test\_husky.py::test\_target\_internal\_ramp[900000-0-internal-5000000.0-True-1-12-True-65536-65536-True-1-0-slowerstream12]
    test\_husky.py::test\_target\_internal\_ramp[max-0-internal-15000000.0-True-1-12-False-65536-65536-True-1-0-maxsamples12]
      /home/testserveradmin/chipwhisperer/tests/test\_husky.py:216: RuntimeWarning: overflow encountered in scalar add
        if byte != (current\_count+1)%MOD:
    ...
    test\_husky.py::test\_target\_internal\_ramp[900000-0-internal-5000000.0-True-1-12-True-65536-65536-True-1-0-slowerstream12]
    test\_husky.py::test\_target\_internal\_ramp[max-0-internal-15000000.0-True-1-12-False-65536-65536-True-1-0-maxsamples12]
      /home/testserveradmin/chipwhisperer/tests/test\_husky.py:223: RuntimeWarning: overflow encountered in scalar add
        current\_count += 1
    ...
    [31m= [31m[1m16 failed[0m, [32m55 passed[0m, [33m95 skipped[0m, [33m6 deselected[0m, [33m12 warnings[0m[31m in 80.99s (0:01:20)[0m[31m =[0m
